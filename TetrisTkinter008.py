...
# 将原作者使用的pygame库，改为python内置的tkinter库，免除python版本升级烦恼
...
def draw_window(win):
    # 删除canvas上已有的所有对象，重新绘制画布上的对象，否则游戏运行越来越慢
    canvas.delete("all")
    ...
    canvas.create_rectangle(top_left_x, top_left_y, top_left_x +
                            play_width, top_left_y+play_height, outline="#ff6400", width=5)
